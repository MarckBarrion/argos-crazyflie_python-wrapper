...
Some sections adapted from the work of Dr. Volker Strobel et al.: https://iridia.ulb.ac.be/~vstrobel/articles/StrPacDor2023scirobotics.pdf
...
Install the additional dependencies for the ARGoS-Blockchain project us

```shell
pip3 install rpyc aenum hexbytes web3 graphviz seaborn pydotplus networkx[default]

```
Or alternatively, you may select which to install:
